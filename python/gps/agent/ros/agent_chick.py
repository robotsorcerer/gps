""" This file defines an agent for the Superchick ROS environment. """
import copy
import time
import numpy as np
...
class AgentCHICK(Agent):
    ...
    def __init__(self, hyperparams, init_node=True):
        ...
        self.use_tf = True  #Overriding caffe for tensor flow
    ...
    def relax_arm(self, arm):
        ...
        Args:
            arm: Either BASE_BLADDER or RIGHT_BLADDER.
        """
    ...
    def reset_arm(self, arm, mode, data):
        """
        Issues a position command to a bladder.
        Args:
            arm: Either BASE_BLADDER or RIGHT_BLADDER.
    ...
    def reset(self, condition):
        ...
        self.reset_arm(BASE_BLADDER, condition_data[BASE_BLADDER]['mode'],
                       condition_data[BASE_BLADDER]['data'])
        self.reset_arm(RIGHT_BLADDER, condition_data[RIGHT_BLADDER]['mode'],
                       condition_data[RIGHT_BLADDER]['data'])
        self.reset_arm(LEFT_BLADDER, condition_data[LEFT_BLADDER]['mode'],
                       condition_data[LEFT_BLADDER]['data'])

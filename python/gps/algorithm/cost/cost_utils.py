...
# DO not penalize fk costs during adversarial training
# def evall1l2term_ant(wp, d, Jd, Jdd, l1, l2, alpha):
#     """
...
# Do not penalize the fk costs while training adversary
...
#     noise = np.random.rand(l.shape[0])
#     noise = np.linalg.norm(noise**2, ord=2, axis=0, keepdims=True) #take the l2 norm
#     # l -=  gamma * noise #do not penalize the fk costs
#     # First order derivative terms.
#     d1 = dscl * l2 + (

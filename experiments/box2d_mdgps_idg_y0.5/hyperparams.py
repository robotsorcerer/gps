...
EXP_DIR = BASE_DIR + '/../experiments/box2d_mdgps_idg_y0.5/'

common = {
    'experiment_name': 'box2d_mdgps_y0.5' + '_' + \
...
algorithm['dynamics'] = {
    ...
    'prior': {
        ...
        'max_clusters': 40, # was 20
        'min_samples_per_cluster': 80, # was 40
        'max_samples': 40, # was 20
    },
}

...
bool GPSSuperchickPlugin::init(superchick_mechanism_model::RobotState* robot, ros::NodeHandle& n)
{
    // Variables.
...
void GPSSuperchickPlugin::get_joint_encoder_readings(Eigen::VectorXd &angles, gps::ActuatorType arm) const
{
...
PLUGINLIB_DECLARE_CLASS(gps_agent_pkg, GPSSuperchickPlugin,
